        ...
        <div class="w-full">
            <div class="w-full mt-5 flex justify-center">
                <form action="{{ route('form.store') }}" method="POST" class="w-full sm:!w-5/6">
                                ...
                                {{-- BODY --}}
                                    <div id="part1" class="flex w-full">
                                        ...
                                        <div class="partSelect flex flex-col relative optionDiv w-[25%] border-b border-r border-gray-400 pb-2.5 px-5">
                                            <input type="text" name="part_number_1" class="inputOption partsInputOption w-full border-0 border-b bg-gray-100 focus:border-blue-500 focus:border-b-2 focus:ring-0 text-center pb-1 pt-3" autocomplete="off" required>
                    ...
                    <div class="flex justify-between gap-x-5 w-full pb-40">
