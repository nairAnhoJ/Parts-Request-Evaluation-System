                ...
                <form action="{{ route('users.store') }}" method="POST" class="w-full sm:!w-[500px]">
                    ...
                    <div class="mb-8">
                        ...
                        <select id="role" name="role" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                          <option value="1">TECHNICIAN / SERVICE COORDINATOR</option>
                          <option value="2">SERVICE HEAD</option>
                          <option value="3">PARTS EVALUATOR</option>
                          <option value="4">SALES QUOTATION ENCODER</option>
                        </select>
                    </div>
